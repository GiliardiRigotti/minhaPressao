...
export default function Input({ title, onChangeText, placeholder, secureTextEntry = false, textArea = false, value, width = 50, keyboardType = "default", max = 100, number = false }: Props) {
